...
class DeodorantsSpider(scrapy.Spider):
    name = 'deodorant'
    custom_settings = {
        'LOG_ENCODING': 'UTF-8',
    ...
    def start_requests(self):
        urls = ['https://www.amazon.in/s?i=beauty&bbn=1374276031&rh=n%3A1355016031%2Cn%3A%211355017031%2Cn%3A1374276031%2Cn%3A1374596031%2Cp_85%3A10440599031&pf_rd_i=1374407031&pf_rd_m=A1VBAL9TL5WCBF&pf_rd_p=0999abdc-7b2a-4628-993b-b579d3dde055&pf_rd_r=PJH8N2A7CTX3D4Y3BHXY&pf_rd_s=merchandised-search-8&ref=QAQuad11CTA_en_IN_3']

        i = 1
        while i < 40:
            i += 1
            urls.append(f'https://www.amazon.in/s?i=beauty&bbn=1374276031&rh=n%3A1355016031%2Cn%3A1355017031%2Cn%3A1374276031%2Cn%3A1374596031%2Cp_85%3A10440599031&page={i}&pf_rd_i=1374407031&pf_rd_m=A1VBAL9TL5WCBF&pf_rd_p=0999abdc-7b2a-4628-993b-b579d3dde055&pf_rd_r=PJH8N2A7CTX3D4Y3BHXY&pf_rd_s=merchandised-search-8&qid=1615835715&ref=sr_pg_{i}')

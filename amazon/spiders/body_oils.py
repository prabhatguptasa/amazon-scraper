...
class BodyOilsSpider(scrapy.Spider):
    name = 'body_oil'
    custom_settings = {
        'LOG_ENCODING': 'UTF-8',
    ...
    def start_requests(self):
        urls = ['https://www.amazon.in/s?i=beauty&bbn=1374408031&rh=n%3A1355016031%2Cn%3A%211355017031%2Cn%3A1374407031%2Cn%3A1374408031%2Cn%3A1374412031%2Cp_85%3A10440599031&pf_rd_i=1374407031&pf_rd_m=A1VBAL9TL5WCBF&pf_rd_p=217dbcc0-819b-439f-ad72-601b8fd88630&pf_rd_r=PJH8N2A7CTX3D4Y3BHXY&pf_rd_s=merchandised-search-9&ref=QANav11CTA_en_IN_2']

        i = 1
        while i < 40:
            i += 1
            urls.append(f'https://www.amazon.in/s?i=beauty&bbn=1374408031&rh=n%3A1355016031%2Cn%3A1355017031%2Cn%3A1374407031%2Cn%3A1374408031%2Cn%3A1374412031%2Cp_85%3A10440599031&page={i}&pf_rd_i=1374407031&pf_rd_m=A1VBAL9TL5WCBF&pf_rd_p=217dbcc0-819b-439f-ad72-601b8fd88630&pf_rd_r=PJH8N2A7CTX3D4Y3BHXY&pf_rd_s=merchandised-search-9&qid=1615835946&ref=sr_pg_{i}')

...
class HairSerumsSpider(scrapy.Spider):
    name = 'hair_serum'
    custom_settings = {
        'LOG_ENCODING': 'UTF-8',
    ...
    def start_requests(self):
        urls = ['https://www.amazon.in/s?rh=n%3A1374342031&fs=true']

        i = 1
        while i < 40:
            i += 1
            urls.append(f'https://www.amazon.in/s?i=beauty&rh=n%3A1374342031&page={i}')

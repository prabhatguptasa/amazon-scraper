...
class HennasSpider(scrapy.Spider):
    name = 'henna'
    custom_settings = {
        'LOG_ENCODING': 'UTF-8',
    ...
    def start_requests(self):
        urls = ['https://www.amazon.in/s?rh=n%3A1374315031&fs=true']

        i = 1
        while i < 40:
            i += 1
            urls.append(f'https://www.amazon.in/s?i=beauty&rh=n%3A1374315031&page={i}')
